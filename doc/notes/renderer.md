# Contracts between **System ⇄ UI ⇄ Renderer**.
...
# Renderer Contract (Mandatory Interface)
...
# Renderer Invariants (Hard Rules)
...
# UI Bridge Contract (Renderer → System)
...
# Event Flow Example (Click → Highlight)
...
# Minimal Renderer Skeleton (Example)
